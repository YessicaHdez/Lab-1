...
class ApplicationTests {
    ...
    public static void setUp() {
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\Yessica\\Downloads\\chromedriver.exe");
    ...
    public void givenAClient_whenEnteringLoginCredentials_thenAccountPageIsDisplayed() throws Exception {
        ...
        emailField.sendKeys("a01561794@itesm.mx");
        WebElement passwordField = driver.findElement(By.id("passwd"));
        passwordField.sendKeys("CANONPERRITo");
